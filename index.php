  ...
  <section class="ticket" id="ticket">
    ...
    <div class="tkt-cntainer">
      <div class="tkt-wrapper">
        ...
        <a href="buy-ticket.php"><button class="btn-biru" name="jakarta">BUY TICKET</button></a>
      </div>
      <div class="tkt-wrapper">
        <div class="tkt-info">
        ...
        <div class="tkt-gris"></div>
        <a href="buy-bandung.php"><button class="btn-biru" name="bandung">BUY TICKET</button></a>
      </div>
      <div class="tkt-wrapper">
        <div class="tkt-info">
        ...
        <div class="tkt-gris"></div>
        <a href="buy-malang.php"><button class="btn-biru" name="malang">BUY TICKET</button></a>
      </div>
      <div class="tkt-wrapper">
        <div class="tkt-info">
