...
$hasilQuery = getData($conn, "SELECT * FROM konser WHERE id = 8");
$hasilQuery2 = getData($conn, "SELECT * FROM konser WHERE id = 9");
$hasilQuery3 = getData($conn, "SELECT * FROM konser WHERE id = 10");
