...
$hasilQuery = getData($conn, "SELECT * FROM konser WHERE id=11");
$hasilQuery2 = getData($conn, "SELECT * FROM konser WHERE id=12");
$hasilQuery3 = getData($conn, "SELECT * FROM konser WHERE id= 13");
